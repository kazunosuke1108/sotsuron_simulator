...
np.savetxt(os.environ['HOME']+'/catkin_ws/src/ytlab_hsr/ytlab_hsr_modules/exp_data/u.csv',u,delimiter=",")
...
np.savetxt(os.environ['HOME']+f'/catkin_ws/src/ytlab_hsr/ytlab_hsr_modules/exp_data/u_{now}.csv',u,delimiter=",")
eng.quit()